...
def main(_argv):
    ...
    while True:
        ...
        for track in tracker.tracks:
            ...
            x0 = int(float(FLAGS.coordinates[0]))
            x1 = int(float(FLAGS.coordinates[1]))
            x2 = int(float(FLAGS.coordinates[2]))
            x3 = int(float(FLAGS.coordinates[3]))
            y0 = int(float(FLAGS.coordinates[4]))
            y1 = int(float(FLAGS.coordinates[5]))
            y2 = int(float(FLAGS.coordinates[6]))
            y3 = int(float(FLAGS.coordinates[7]))
